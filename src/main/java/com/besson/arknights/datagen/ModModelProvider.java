...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.INTERPRETATION_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.MONASTERY_CHANDELIER);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.SOLID_WOOD_PRAYER_PLATFORM);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.SOLID_WOOD_STATUE_WALL_CABINET);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.BRICK_WALL_SENTRY);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.DIZZY_SWIVEL_CHAIR);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.DRIFTING_HELMSMAN);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.DWARF_REFRIGERATOR);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.FLAVOR_MAGE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.LARGE_ARMCHAIR_THAT_CAN_BE_ROTATED);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.LETAOTAO_SPLICING_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.NURSERY_RHYME_GUARD);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.SMALL_STOOL_THAT_CAN_BE_SWAM);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.SOFT_CANDY_COMPANION);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.TEA_AND_RICE_ATTENDANT);

        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.CONCEALED_CAST_IRON_OIL_LAMP);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.FOREST_CHARCOAL_STOVE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.PRAYERS_ON_WINTER_NIGHTS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.SILENT_INTIMACY);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.THE_GUARDS_OF_WINTER_NIGHTS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.WARM_LONELINESS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.WARM_STORAGE_BOX);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.DRINKING_BOTTLE_TREE_WATER_MACHINE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.GNAWING_FLOOR_PROCESSING_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.GUYUAN_ROCK_SHOVEL);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.HUNDRED_CATTIES_TOP);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.LOCKED_UNICYCLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.RENEWABLE_SNACK_BOWL);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.VERY_DANGEROUS_POWER_CABINET);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotation(ModBlocks.VERY_SIMPLE_CONSOLE);
