...
public class ConnectedCabinetTypeIronMeshPartition extends FurnitureHorizontalFacingBlock {
    ...
    public ConnectedCabinetTypeIronMeshPartition(Settings settings) {
        super(settings);
    }
